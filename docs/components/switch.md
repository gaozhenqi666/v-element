...
<preview path="../demo/Switch/Text.vue" title="文字描述" description="Switch 支持文字描述"></preview>
...
| active-text           | 开启文案        | `string`                      | —       |
| inactive-text         | 关闭文案        | `string`                      | —       |

## Switch Events

| Name   | Description | Type                                           |
| ------ | ----------- | ---------------------------------------------- |
| change | 状态变化        | `(value: boolean \| string \| number) => void` |
